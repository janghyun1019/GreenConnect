...
public class SignupController {
	...
	public String signupAction(@RequestBody User user) {
		...
		if (user.getUserId() == null || ((String) user.getUserId()).trim().isEmpty()) {
	...
	public String login(@RequestBody Map<String, String> loginInfo, User user) throws NoSuchAlgorithmException {
		...
		try {
			...
			Map<String, Object> response = Map.of("accessToken", accessToken, "refreshToken", refreshToken, "nickname",
					user.getNickName());
